...
public class PlayerRollbackManager {
    ...
    public void save(Player player) {
        ...
        previousLocation.put(uuid, player.getLocation());
    ...
    public void restore(Player player, DuelsPlugin plugin) {
        UUID uuid = player.getUniqueId();
        player.getInventory().clear();
        ...
        Location previousLocation = this.previousLocation.get(uuid);
        ...
        this.previousLocation.remove(uuid);
        ...
        plugin.getServer().getScheduler().runTaskLater(plugin, () -> player.setFireTicks(0), 2);
    }
